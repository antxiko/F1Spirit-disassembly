...
L_BF56:
	...
	jr L_BF69		;bf67
L_BF69:
	ld (0e1deh),a		;bf69	; Variable detección cartucho Konami
	ret			;bf6c
...
COMPARA_FIRMAS:		; carry si alguna de las tres firmas coincide
	...
	ld a,002h		;bf86	; Valor detección cartucho Konami (siempre 2)
	ret c			;bf88
	call FIRMA_BFFA		;bf89	; Comprueba firma RC746 = QBERT
	ld a,002h		;bf8c	; Valor detección cartucho Konami (siempre 2)
	ret c			;bf8e
	call FIRMA_7FFA		;bf8f	; Comprueba firma RC735 = Game Master
	ld a,002h		;bf92	; Valor detección cartucho Konami (siempre 2)
	ret			;bf94
FIRMA_4010:		; 5 bytes en 0x4010 contra 0xBFD2
	ld de,0bfd2h		;bf95	; Datos firma RC745 = King Kong 2
	ld hl,04010h		;bf98	; Dirección esperada firma
	ld b,005h		;bf9b	; Longitud firma
	jr COMPARA_B_BYTES		;bf9d
FIRMA_BFFA:		; 6 bytes en 0xBFFA contra 0xBFCC
	ld de,0bfcch		;bf9f	; Datos firma RC746 = QBERT
	ld hl,0bffah		;bfa2	; Dirección esperada firma
	ld b,006h		;bfa5	; Longitud firma
	jr COMPARA_B_BYTES		;bfa7
FIRMA_7FFA:		; 6 bytes en 0x7FFA contra 0xBFC6
	ld de,0bfc6h		;bfa9	; Datos firma RC735 = Game Master
	ld hl,07ffah		;bfac	; Dirección esperada firma
	ld b,006h		;bfaf	; Longitud firma
...
; ----------------------------------------------------------------------
; DATOS firma_7FFA: 00 30 31 13 35 AA: al final del cartucho.
...
; ----------------------------------------------------------------------
; DATOS firma_BFFA: BA B2 86 07 46 AA: al final del cartucho.
...
; ----------------------------------------------------------------------
; DATOS firma_4010: "CD" 07 45 FF al principio del cartucho.
